import * as THREE from 'three';
            ...
            const sphereTexture = new THREE.TextureLoader().load('/assets/img/sphereTextureManzana.png')
			...
			function init() {
				...
				image.src = '/assets/img/sphereTextureManzana.png';
